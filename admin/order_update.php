...
$remark=$_POST['remark'];   
if(empty($remark))
     { $query=mysqli_query($db,"insert into remark(o_id,remark) values('$o_id','Not Updated')");
     }
else{
$query=mysqli_query($db,"insert into remark(o_id,remark) values('$o_id','$remark')");
}
...
<table  border="0" cellspacing="0" cellpadding="0">
     <tr >
      ...
      <td><?php echo htmlentities($_GET['o_id']); ?></td>
    </tr>
	<tr>
      <td  >&nbsp;</td>
