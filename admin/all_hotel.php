                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Hotel</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM hotel order by hot_id desc";
												$query=mysqli_query($db,$sql);
												
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No hotel</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$mql="SELECT * FROM hot_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr><td>'.$row['c_name'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete_hotel.php?res_del='.$rows['hot_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_hotel.php?res_upd='.$rows['hot_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
