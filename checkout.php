...
if(empty($_SESSION["user_id"]))
{
	header('location:login.php');
                                                ...
                                                $item_t = ($item["price"]*$item["quantity"]);
												//$dish_id="SELECT u.u_id from users u,users_orders uo where u.u_id=uo.u_id;"
													if($_POST['submit'])
													{
                                                    
                                                        $SQL="INSERT into users_orders(u_id,d_id,quantity,total_price,status) values('".$_SESSION["user_id"]."','".$item["d_id"]."','".$item["quantity"]."','$item_t','Just Ordered')";
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="hotel.php">Choose Hotel</a></li>
