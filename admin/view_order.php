                            ...
                            <div class="card-header">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT * from users_orders uo,users u,dishes d where uo.u_id=u.u_id and uo.d_id=d.d_id and uo.o_id='".$_GET['user_upd']."'";
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?o_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
											...
											<tr>
												<td><strong>Title:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													    <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newo_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
