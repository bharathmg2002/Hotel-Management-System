...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/img/a9.webp">
                <div class="container"> </div>
        
            </div>
            <div class="result-show">
				<p align="right"><a href="delete_order.php">Previously Deleted Orders</a></p>
                <div class="container">
                    <div class="row">
            ...
            <section class="hotel-page">
                <div class="container">
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders uo,dishes d where uo.d_id=d.d_id and uo.u_id='".$_SESSION['user_id']."'");
												...
												<tr>	
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">
														   ...
														   <?php 
																			$status=$row['status'];
																			if($status=="" or $status=="NULL" or $status=="Just Ordered")
																			{
																			?>
