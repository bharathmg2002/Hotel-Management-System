...
<head>
    ...
    <style>h3.textstyle{font-family: cursive}</style> </head>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="hotel.php">Hotels <span class="sr-only"></span></a> </li>
						...
						?>
							<li class="nav-item"> <a class="nav-link active" href="#footer">Contact Us <span class="sr-only"></span></a> </li> 
                        </ul>
...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/a12.jpg" style=" padding-bottom: 15%;">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>" Hotel Management System "</h1> <br><br>
                  <h3 class="textstyle" style="color:white"><strong> Order Delivery & Take-Out</strong></h3>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Hotel</h4> </div>
        ...
        <section class="featured-hotel" style="background: url(images/img/a13.jpg);background-size:cover;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4 style="color:white;"><strong>Featured Hotel</strong></h4> </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="hotel-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
                                    <li><a href="#" class="selected" data-filter="*" style="color:white;"><strong>ALL</strong></a> </li>
									<?php 
									$res= mysqli_query($db,"select * from hot_category");
									      while($row=mysqli_fetch_array($res))
										  {
											echo '<li><a href="#" data-filter=".'.$row['c_name'].'" style="color:white;"><strong> '.$row['c_name'].'</strong></a> </li>';
										  }
									?>
                ...
                <div class="row">
                    <div class="hotel-listing">
						...
						<?php  
						$ress= mysqli_query($db,"select * from hotel ");  
									      while($rows=mysqli_fetch_array($ress))
										  {
													
													$query= mysqli_query($db,"select * from hot_category where c_id='".$rows['c_id']."' ");
													 $rowss=mysqli_fetch_array($query);
						
													 echo ' <div class="col-xs-12 col-sm-12 col-md-6 single-hotel all '.$rowss['c_name'].'">
														<div class="hotel-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="hotel-logo" href="dishes.php?hot_id='.$rows['hot_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="hotel logo"> </a>
																</div>
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?hot_id='.$rows['hot_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																</div>
        ...
        <section class="popular,hero bg-image" data-image-src="images/img/a13.jpg">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <br>
                    <h2 style="color:white;">Popular Dishes of the Month</h2>
                    <p class="lead" style="color:white;">The easiest way to your favourite food</p>
                </div>
                <div class="row">
						<?php 					
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="dishes.php?hot_id='.$r['hot_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">₹'.$r['price'].'</span> <a href="dishes.php?hot_id='.$r['hot_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from a variety of delivery Hotel online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a Dish</h3>
                                <p>We"ve got your covered with a variety of delivery Hotel online.</p>
                            </div>
                        </div>
       ...
       <section id="footer"  style="background-image: url(../images/img/a14.jpg);">
                ...
                <div class="bottom-footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Canara Engineering College, Benjanapadav, Bantwal, Karnataka, 574219, India</p>
                                    <h5>Phone: +91 9141589834</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of other Hotel who benefit from having partnered with us.</p>
                                </div>
                    </div>
                </div>
